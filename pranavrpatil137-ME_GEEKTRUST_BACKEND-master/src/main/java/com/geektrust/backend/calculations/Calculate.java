package com.geektrust.backend.calculations;
...
public class Calculate {
    ...
    public static Direction[] directionToGo(Point source, Point destination) {
        Direction xDir;
        Direction yDir;
    ...
    public static int changeInDir(Direction currentDirection, Direction[] directionToGo) {
